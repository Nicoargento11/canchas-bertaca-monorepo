...
export class GiftProductItemDto {
  ...
  @ApiProperty({
    description: 'Cantidad de este producto a regalar',
    default: 1,
  })
  @IsNumber()
  @Min(1)
...
export class CreatePromotionDto {
  ...
  @ApiPropertyOptional({
    description: 'ID del tipo de deporte (null = aplica a todos)',
  })
  @IsString()
  @IsOptional()
  sportTypeId?: string;
  ...
  @ApiPropertyOptional({
    description: 'ID de la cancha específica (null = aplica a todas)',
  })
  @IsString()
  @IsOptional()
  courtId?: string;
  ...
  @ApiPropertyOptional({
    description:
      '[DEPRECADO] ID del producto que se regala (usar giftProducts)',
  })
  @ValidateIf((o) => o.type === 'GIFT_PRODUCT')
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Lista de productos a regalar con cantidades (solo para GIFT_PRODUCT)',
  ...
  @ApiPropertyOptional({
    description: 'ID del producto al que aplica la promoción (para PRODUCT_*)',
  })
  ...
  @ApiPropertyOptional({
    description: 'Cantidad que lleva el cliente (para PRODUCT_BUY_X_PAY_Y)',
    example: 2,
  })
  ...
  @ApiPropertyOptional({
    description: 'Cantidad que paga el cliente (para PRODUCT_BUY_X_PAY_Y)',
    example: 1,
  })
  @ValidateIf((o) => o.type === 'PRODUCT_BUY_X_PAY_Y')
  @IsNumber()
